...
func exampleProfileNode(profile Profile) *yaml.Node {
	...
	entries := []yamlNodeEntry{
		...
		yamlEntry("min_p", optionalFloatNode(profile.MinP)),
		yamlEntry("presence_penalty", optionalFloatNode(profile.PresencePenalty)),
		yamlEntry("repetition_penalty", optionalFloatNode(profile.RepetitionPenalty)),
		...
		yamlEntry("project_context", stringSliceNode(profile.ProjectContext)),
		yamlEntry("disable_project_context", yamlBool(profile.DisableProjectContext)),
...
func smallModelNode(small SmallModelConfig) *yaml.Node {
	return yamlMapping(
		...
		yamlEntry("min_p", optionalFloatNode(small.MinP)),
		yamlEntry("presence_penalty", optionalFloatNode(small.PresencePenalty)),
		yamlEntry("repetition_penalty", optionalFloatNode(small.RepetitionPenalty)),
